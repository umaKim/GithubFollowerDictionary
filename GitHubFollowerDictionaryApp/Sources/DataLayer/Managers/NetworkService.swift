...
final public class NetworkService: NetworkServiceProtocol {
    public func fetchFollowerList(of userName: String) -> AnyPublisher<[Follower], GFError> {
    ...
    public func fetchFollowerDetail(of userName: String) -> AnyPublisher<FollowerDetailInformation, GFError> {
