...
final public class FollowerListViewController: BaseViewController<FollowerListViewModel> {
    ...
    public override init(of viewModel: FollowerListViewModel) {
...
extension FollowerListViewController {
    ...
    private func configureDiffableDataSource() {
        diffableDataSource = DataSource(
            collectionView: contentView.collectionView, cellProvider: { collectionView, indexPath, follower in
